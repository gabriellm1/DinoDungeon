...
public class CameraController : MonoBehaviour
{
    ...
    public float cameraXOffset = 3.0f; // Define o deslocamento em X em relação ao personagem
    public float cameraYOffset = 0.0f; // Define o deslocamento em Y em relação ao personagem
